...
<!--面包屑导航 开始-->
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="{{url('admin/article')}}">文章管理</a> &raquo; 新增文章
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>缩略图：</th>
                        <td>
                            <input type="text" size="50" name="art_thumb" style="height: 17px;">
