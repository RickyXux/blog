	...
	<ul>
		<li>
			...
			<ul class="sub_menu">
				...
				<li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-list-alt"></i>友情链接管理</a></li>
...
<div class="bottom_box">
	CopyRight © 2016. Powered By <a href="http://www.houdunwang.com">http://www.ricky.com</a>.
</div>
<!--底部 结束-->
		@endsection