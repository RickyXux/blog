...
<!--面包屑导航 开始-->
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="{{url('admin/links')}}">友情链接</a> &raquo; 编辑链接
    </div>
    <!--面包屑导航 结束-->
        ...
        {{csrf_field()}}
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="50" name="link_url" value="{{$field->link_url}}">
